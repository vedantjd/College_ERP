...
from .models import StudentCourse, Marks, User, AttendanceRange,HOD
...
class AssignAdmin(admin.ModelAdmin):
    ...
    ordering = ['class_id__dept__name', 'class_id__id', 'course__id', 'course__name']
...
class StudentCourseAdmin(admin.ModelAdmin):
    ...
    ordering = ('student__class_id__dept__name', 'student__class_id__id', 'student__USN', 'course__name')
