...
time_slots = (
    ...
    ('01:45 - 02:45', '01:45 - 02:45'),
    ('02:45 - 03:30', '02:45 - 03:30'),
...
class HOD(models.Model):
    ...
    hod_id = models.ForeignKey(Teacher,on_delete=models.CASCADE)
    department = models.ForeignKey(Dept, on_delete=models.CASCADE)

    def __str__(self):
        return f"{self.hod_id} ({self.department})"
        ...
        if hasattr(instance, 'name'):
            ...
            for ass in ass_list:
                try:
                    ...
                    sc.marks_set.create(name='Midsem Exam')
