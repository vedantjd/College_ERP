    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hod_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='info.teacher')),
            ],
        ),
        migrations.AddField(
            model_name='course',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('period', models.CharField(choices=[('10:00 - 11:00', '10:00 - 11:00'), ('11:00 - 12:00', '11:00 - 12:00'), ('12:00 - 01:00', '12:00 - 01:00'), ('01:45 - 02:45', '01:45 - 02:45'), ('02:45 - 03:30', '02:45 - 03:30'), ('03:30 - 04:30', '03:30 - 04:30'), ('04:30 - 05:30', '04:30 - 05:30')], default='10:00 - 11:00', max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(choices=[('Class Test 1', 'Class Test 1'), ('Midsem Exam', 'Midsem Exam'), ('Class Test 2', 'Class Test 2'), ('Event 1', 'Event 1'), ('Event 2', 'Event 2'), ('End Semester Exam', 'End Semester Exam')], default='Class Test 1', max_length=50)),
